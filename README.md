[README.md](https://github.com/user-attachments/files/31179181/README.md)
...
**[Consulter le projet](https://github.com/Bangerzekers/Cybersecurity-Portfolio/blob/main/network-monitoring-zabbix-grafana/README.md)**
...
**[Consulter le projet](https://github.com/Bangerzekers/Cybersecurity-Portfolio/blob/main/ansible-aruba-backups/README.md)**
...
**[Consulter le projet](https://github.com/Bangerzekers/Cybersecurity-Portfolio/blob/main/soc-sentinel/README.md)** — Compétences : Microsoft Sentinel, KQL, Windows Event Logs, triage, chronologie d'incident.
...
**[Consulter le projet](https://github.com/Bangerzekers/Cybersecurity-Portfolio/blob/main/entra-id-security-audit/README.md)** — Compétences : IAM, Entra ID, MFA, Conditional Access, RBAC, PowerShell/Graph.
...
**[Consulter le projet](https://github.com/Bangerzekers/Cybersecurity-Portfolio/blob/main/vulnerability-management/README.md)** — Compétences : CVSS, Nmap, scanners de vulnérabilités, priorisation, reporting.
